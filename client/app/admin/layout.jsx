    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-56 bg-white border-r border-gray-100 flex flex-col fixed top-16 bottom-0 z-40">
        ...
        <div className="p-3 border-t border-gray-100">
          <Link href="/" className="flex items-center gap-2 px-3 py-2 text-sm text-gray-500 hover:text-gray-800 rounded-lg hover:bg-gray-50 transition-colors">
