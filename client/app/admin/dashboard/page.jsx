      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/products" className="text-xs hover:underline" style={{ color: 'var(--color-brand)' }}>View all</Link>
          </div>
                ...
                <div key={p._id} className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-3">
                    <span className="w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold text-white flex-shrink-0"
                      style={{ backgroundColor: 'var(--color-brand)' }}>{i + 1}</span>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/admin/products" className="text-xs hover:underline" style={{ color: 'var(--color-brand)' }}>Manage</Link>
          </div>
